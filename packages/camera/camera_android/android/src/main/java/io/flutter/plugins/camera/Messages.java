...
public class Messages {
  ...
  public enum PlatformWhiteBalanceMode {
    AUTO(0),
    LOCKED(1);

    final int index;

    PlatformWhiteBalanceMode(final int index) {
      this.index = index;
    }
  }

  /** Pigeon equivalent of [ColorEffect]. */
  public enum PlatformColorEffect {
    NONE(0),
    MONO(1),
    NEGATIVE(2),
    SEPIA(3),
    ...
    PlatformColorEffect(final int index) {
      this.index = index;
    }
  }
  ...
  public static final class PlatformCameraState {
    ...
    private @NonNull PlatformWhiteBalanceMode whiteBalanceMode;

    public @NonNull PlatformWhiteBalanceMode getWhiteBalanceMode() {
      return whiteBalanceMode;
    }

    public void setWhiteBalanceMode(@NonNull PlatformWhiteBalanceMode setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"whiteBalanceMode\" is null.");
      }
      this.whiteBalanceMode = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(previewSize, that.previewSize) && pigeonDeepEquals(exposureMode, that.exposureMode) && pigeonDeepEquals(focusMode, that.focusMode) && pigeonDeepEquals(whiteBalanceMode, that.whiteBalanceMode) && pigeonDeepEquals(exposurePointSupported, that.exposurePointSupported) && pigeonDeepEquals(focusPointSupported, that.focusPointSupported);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), previewSize, exposureMode, focusMode, whiteBalanceMode, exposurePointSupported, focusPointSupported};
      return pigeonDeepHashCode(fields);
    }
    ...
    public static final class Builder {
      ...
      private @Nullable PlatformWhiteBalanceMode whiteBalanceMode;

      @CanIgnoreReturnValue
      public @NonNull Builder setWhiteBalanceMode(@NonNull PlatformWhiteBalanceMode setterArg) {
        this.whiteBalanceMode = setterArg;
        return this;
      }
      ...
      public @NonNull PlatformCameraState build() {
        ...
        pigeonReturn.setWhiteBalanceMode(whiteBalanceMode);
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(whiteBalanceMode);
    ...
    static @NonNull PlatformCameraState fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object whiteBalanceMode = pigeonVar_list.get(3);
      pigeonResult.setWhiteBalanceMode((PlatformWhiteBalanceMode) whiteBalanceMode);
      Object exposurePointSupported = pigeonVar_list.get(4);
      pigeonResult.setExposurePointSupported((Boolean) exposurePointSupported);
      Object focusPointSupported = pigeonVar_list.get(5);
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class PlatformFrameRateRange {
    private @NonNull Long minFrameRate;

    public @NonNull Long getMinFrameRate() {
      return minFrameRate;
    }

    public void setMinFrameRate(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"minFrameRate\" is null.");
      }
      this.minFrameRate = setterArg;
    }

    private @NonNull Long maxFrameRate;

    public @NonNull Long getMaxFrameRate() {
      return maxFrameRate;
    }

    public void setMaxFrameRate(@NonNull Long setterArg) {
      if (setterArg == null) {
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PlatformFrameRateRange that = (PlatformFrameRateRange) o;
      return pigeonDeepEquals(minFrameRate, that.minFrameRate) && pigeonDeepEquals(maxFrameRate, that.maxFrameRate);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), minFrameRate, maxFrameRate};
      return pigeonDeepHashCode(fields);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setMinFrameRate(@NonNull Long setterArg) {
        this.minFrameRate = setterArg;
        return this;
      }
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setMaxFrameRate(@NonNull Long setterArg) {
        this.maxFrameRate = setterArg;
        return this;
      }

      public @NonNull PlatformFrameRateRange build() {
        PlatformFrameRateRange pigeonReturn = new PlatformFrameRateRange();
    ...
    static @NonNull PlatformFrameRateRange fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      PlatformFrameRateRange pigeonResult = new PlatformFrameRateRange();
      Object minFrameRate = pigeonVar_list.get(0);
      pigeonResult.setMinFrameRate((Long) minFrameRate);
      Object maxFrameRate = pigeonVar_list.get(1);
      pigeonResult.setMaxFrameRate((Long) maxFrameRate);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 133: {
          Object value = readValue(buffer);
          return value == null ? null : PlatformWhiteBalanceMode.values()[((Long) value).intValue()];
        }
        case (byte) 134: {
          Object value = readValue(buffer);
          return value == null ? null : PlatformColorEffect.values()[((Long) value).intValue()];
        }
        case (byte) 135: {
          Object value = readValue(buffer);
        ...
        case (byte) 142:
          return PlatformFrameRateRange.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 143:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PlatformWhiteBalanceMode) {
        stream.write(133);
        writeValue(stream, value == null ? null : ((PlatformWhiteBalanceMode) value).index);
      } else if (value instanceof PlatformColorEffect) {
        stream.write(134);
        writeValue(stream, value == null ? null : ((PlatformColorEffect) value).index);
      ...
      } else if (value instanceof PlatformFrameRateRange) {
        stream.write(142);
        writeValue(stream, ((PlatformFrameRateRange) value).toList());
  ...
  public interface CameraApi {
     ...
     */
    void setManualFocusDistance(@NonNull Double distance, @NonNull VoidResult result);
    ...
    void setManualExposureTime(@NonNull Long exposureTime, @NonNull VoidResult result);
    ...
    void setManualIso(@NonNull Long iso, @NonNull VoidResult result);
    ...
    void setWhiteBalanceMode(@NonNull PlatformWhiteBalanceMode whiteBalanceMode, @NonNull VoidResult result);
    /** Sets the manual color temperature for white balance. */
    void setColorTemperature(@NonNull Long colorTemperature, @NonNull VoidResult result);
    /** Returns the minimum supported color temperature. */
    @NonNull 
    Long getMinColorTemperature();
    /** Returns the maximum supported color temperature. */
    @NonNull 
    Long getMaxColorTemperature();
    ...
    void setFrameRateRange(@NonNull Long minFrameRate, @NonNull Long maxFrameRate, @NonNull VoidResult result);
    ...
    void setVideoStabilization(@NonNull Boolean enabled, @NonNull VoidResult result);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable CameraApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setManualFocusDistance" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.setManualFocusDistance(distanceArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMinFocusDistance" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getMinFocusDistance();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMaxFocusDistance" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getMaxFocusDistance();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setManualExposureTime" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long exposureTimeArg = (Long) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setManualExposureTime(exposureTimeArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMinExposureTime" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMinExposureTime();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMaxExposureTime" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMaxExposureTime();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setManualIso" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long isoArg = (Long) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setManualIso(isoArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMinIso" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMinIso();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMaxIso" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMaxIso();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setWhiteBalanceMode" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                PlatformWhiteBalanceMode whiteBalanceModeArg = (PlatformWhiteBalanceMode) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setWhiteBalanceMode(whiteBalanceModeArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setColorTemperature" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long colorTemperatureArg = (Long) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setColorTemperature(colorTemperatureArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMinColorTemperature" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMinColorTemperature();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMaxColorTemperature" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Long output = api.getMaxColorTemperature();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setFrameRateRange" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Long minFrameRateArg = (Long) args.get(0);
                Long maxFrameRateArg = (Long) args.get(1);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setFrameRateRange(minFrameRateArg, maxFrameRateArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getSupportedFrameRateRanges" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  List<PlatformFrameRateRange> output = api.getSupportedFrameRateRanges();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setVideoStabilization" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.setVideoStabilization(enabledArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.isVideoStabilizationSupported" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Boolean output = api.isVideoStabilizationSupported();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getLensAperture" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getLensAperture();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getFocalLength" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getFocalLength();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setTorchLevel" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.setTorchLevel(levelArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getTorchLevel" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getTorchLevel();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.isTorchLevelSupported" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Boolean output = api.isTorchLevelSupported();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getMaxTorchLevel" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  Double output = api.getMaxTorchLevel();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setColorEffect" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                PlatformColorEffect effectArg = (PlatformColorEffect) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setColorEffect(effectArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.getSupportedColorEffects" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                try {
                  List<PlatformColorEffect> output = api.getSupportedColorEffects();
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
