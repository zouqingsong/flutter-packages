...
enum PlatformWhiteBalanceMode: Int {
  case auto = 0
  case locked = 1
}

enum PlatformColorEffect: Int {
  case none = 0
  case mono = 1
  case negative = 2
  case sepia = 3
...
struct PlatformCameraState: Hashable {
  ...
  var whiteBalanceMode: PlatformWhiteBalanceMode
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PlatformCameraState? {
    ...
    let whiteBalanceMode = pigeonVar_list[3] as! PlatformWhiteBalanceMode
    let exposurePointSupported = pigeonVar_list[4] as! Bool
    let focusPointSupported = pigeonVar_list[5] as! Bool
  ...
  static func == (lhs: PlatformCameraState, rhs: PlatformCameraState) -> Bool {
    ...
    return deepEqualsMessages(lhs.previewSize, rhs.previewSize) && deepEqualsMessages(lhs.exposureMode, rhs.exposureMode) && deepEqualsMessages(lhs.focusMode, rhs.focusMode) && deepEqualsMessages(lhs.whiteBalanceMode, rhs.whiteBalanceMode) && deepEqualsMessages(lhs.exposurePointSupported, rhs.exposurePointSupported) && deepEqualsMessages(lhs.focusPointSupported, rhs.focusPointSupported)
  }
  ...
  func hash(into hasher: inout Hasher) {
    ...
    deepHashMessages(value: whiteBalanceMode, hasher: &hasher)
...
/// Generated class from Pigeon that represents data sent in messages.
struct PlatformFrameRateRange: Hashable {
  var minFrameRate: Int64
  var maxFrameRate: Int64


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PlatformFrameRateRange? {
    let minFrameRate = pigeonVar_list[0] as! Int64
    let maxFrameRate = pigeonVar_list[1] as! Int64
  ...
  static func == (lhs: PlatformFrameRateRange, rhs: PlatformFrameRateRange) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsMessages(lhs.minFrameRate, rhs.minFrameRate) && deepEqualsMessages(lhs.maxFrameRate, rhs.maxFrameRate)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("PlatformFrameRateRange")
    deepHashMessages(value: minFrameRate, hasher: &hasher)
    deepHashMessages(value: maxFrameRate, hasher: &hasher)
  }
}
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 135:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return PlatformWhiteBalanceMode(rawValue: enumResultAsInt)
      }
      return nil
    case 136:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return PlatformColorEffect(rawValue: enumResultAsInt)
      }
      return nil
    case 137:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 148:
      return PlatformFrameRateRange.fromList(self.readValue() as! [Any?])
    default:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? PlatformCameraLensDirection {
      ...
      super.writeByte(134)
      super.writeValue(value.rawValue)
    } else if let value = value as? PlatformWhiteBalanceMode {
      super.writeByte(135)
      super.writeValue(value.rawValue)
    } else if let value = value as? PlatformColorEffect {
      super.writeByte(136)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(147)
      super.writeValue(value.toList())
    } else if let value = value as? PlatformFrameRateRange {
      super.writeByte(148)
      super.writeValue(value.toList())
    } else {
...
protocol CameraApi {
  ...
  func setManualFocusDistance(distance: Double, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the minimum supported manual focus distance.
  func getMinFocusDistance(completion: @escaping (Result<Double, Error>) -> Void)
  /// Returns the maximum supported manual focus distance.
  func getMaxFocusDistance(completion: @escaping (Result<Double, Error>) -> Void)
  /// Sets the manual exposure time (shutter speed) in microseconds.
  func setManualExposureTime(exposureTime: Int64, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the minimum supported exposure time in microseconds.
  func getMinExposureTime(completion: @escaping (Result<Int64, Error>) -> Void)
  /// Returns the maximum supported exposure time in microseconds.
  func getMaxExposureTime(completion: @escaping (Result<Int64, Error>) -> Void)
  /// Sets the manual ISO sensitivity.
  func setManualIso(iso: Int64, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the minimum supported ISO sensitivity.
  func getMinIso(completion: @escaping (Result<Int64, Error>) -> Void)
  /// Returns the maximum supported ISO sensitivity.
  func getMaxIso(completion: @escaping (Result<Int64, Error>) -> Void)
  /// Switches the camera to the given white balance mode.
  func setWhiteBalanceMode(mode: PlatformWhiteBalanceMode, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  func setManualColorTemperature(colorTemperature: Int64, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the minimum supported color temperature in Kelvin.
  func getMinColorTemperature(completion: @escaping (Result<Int64, Error>) -> Void)
  /// Returns the maximum supported color temperature in Kelvin.
  func getMaxColorTemperature(completion: @escaping (Result<Int64, Error>) -> Void)
  ...
  func setFrameRateRange(minFrameRate: Int64, maxFrameRate: Int64, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the supported frame rate ranges.
  func getSupportedFrameRateRanges(completion: @escaping (Result<[PlatformFrameRateRange], Error>) -> Void)
  /// Sets video stabilization mode.
  func setVideoStabilization(enabled: Bool, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns whether video stabilization is supported.
  func isVideoStabilizationSupported(completion: @escaping (Result<Bool, Error>) -> Void)
  /// Returns the lens aperture value.
  func getLensAperture(completion: @escaping (Result<Double, Error>) -> Void)
  /// Returns the focal length in millimeters.
  func getFocalLength(completion: @escaping (Result<Double, Error>) -> Void)
  /// Sets the torch level (0.0 to 1.0).
  func setTorchLevel(level: Double, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  func getMaxTorchLevel(completion: @escaping (Result<Double, Error>) -> Void)
  /// Sets a color effect filter.
  func setColorEffect(effect: PlatformColorEffect, completion: @escaping (Result<Void, Error>) -> Void)
  /// Returns the supported color effects.
  func getSupportedColorEffects(completion: @escaping (Result<[PlatformColorEffect], Error>) -> Void)
}
...
class CameraApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: CameraApi?, messageChannelSuffix: String = "") {
    ...
    /// The distance should be between 0.0 and 1.0, where 0.0 represents
    /// the nearest focus distance and 1.0 represents the farthest (infinity).
    let setManualFocusDistanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setManualFocusDistance\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setManualFocusDistanceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let distanceArg = args[0] as! Double
        api.setManualFocusDistance(distance: distanceArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setManualFocusDistanceChannel.setMessageHandler(nil)
    }
    /// Returns the minimum supported manual focus distance.
    let getMinFocusDistanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinFocusDistance\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMinFocusDistanceChannel.setMessageHandler { _, reply in
        api.getMinFocusDistance { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMinFocusDistanceChannel.setMessageHandler(nil)
    }
    /// Returns the maximum supported manual focus distance.
    let getMaxFocusDistanceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxFocusDistance\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMaxFocusDistanceChannel.setMessageHandler { _, reply in
        api.getMaxFocusDistance { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMaxFocusDistanceChannel.setMessageHandler(nil)
    }
    /// Sets the manual exposure time (shutter speed) in microseconds.
    let setManualExposureTimeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setManualExposureTime\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setManualExposureTimeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let exposureTimeArg = args[0] as! Int64
        api.setManualExposureTime(exposureTime: exposureTimeArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setManualExposureTimeChannel.setMessageHandler(nil)
    }
    /// Returns the minimum supported exposure time in microseconds.
    let getMinExposureTimeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinExposureTime\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMinExposureTimeChannel.setMessageHandler { _, reply in
        api.getMinExposureTime { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMinExposureTimeChannel.setMessageHandler(nil)
    }
    /// Returns the maximum supported exposure time in microseconds.
    let getMaxExposureTimeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxExposureTime\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMaxExposureTimeChannel.setMessageHandler { _, reply in
        api.getMaxExposureTime { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMaxExposureTimeChannel.setMessageHandler(nil)
    }
    /// Sets the manual ISO sensitivity.
    let setManualIsoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setManualIso\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setManualIsoChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let isoArg = args[0] as! Int64
        api.setManualIso(iso: isoArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
    ...
    /// Returns the minimum supported ISO sensitivity.
    let getMinIsoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinIso\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMinIsoChannel.setMessageHandler { _, reply in
        api.getMinIso { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMinIsoChannel.setMessageHandler(nil)
    }
    /// Returns the maximum supported ISO sensitivity.
    let getMaxIsoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxIso\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMaxIsoChannel.setMessageHandler { _, reply in
        api.getMaxIso { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMaxIsoChannel.setMessageHandler(nil)
    }
    /// Switches the camera to the given white balance mode.
    let setWhiteBalanceModeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setWhiteBalanceMode\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setWhiteBalanceModeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let modeArg = args[0] as! PlatformWhiteBalanceMode
        api.setWhiteBalanceMode(mode: modeArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setWhiteBalanceModeChannel.setMessageHandler(nil)
    }
    /// Sets the manual color temperature in Kelvin.
    ///
    /// This should only be used when white balance mode is locked.
    /// Color temperature typically ranges from 2000K to 8000K.
    let setManualColorTemperatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setManualColorTemperature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setManualColorTemperatureChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let colorTemperatureArg = args[0] as! Int64
        api.setManualColorTemperature(colorTemperature: colorTemperatureArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setManualColorTemperatureChannel.setMessageHandler(nil)
    }
    /// Returns the minimum supported color temperature in Kelvin.
    let getMinColorTemperatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinColorTemperature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMinColorTemperatureChannel.setMessageHandler { _, reply in
        api.getMinColorTemperature { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMinColorTemperatureChannel.setMessageHandler(nil)
    }
    /// Returns the maximum supported color temperature in Kelvin.
    let getMaxColorTemperatureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxColorTemperature\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMaxColorTemperatureChannel.setMessageHandler { _, reply in
        api.getMaxColorTemperature { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMaxColorTemperatureChannel.setMessageHandler(nil)
    }
    /// Returns the minimum zoom level supported by the camera.
    ...
    /// Sets the frame rate range for video capture.
    let setFrameRateRangeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setFrameRateRange\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setFrameRateRangeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let minFrameRateArg = args[0] as! Int64
        let maxFrameRateArg = args[1] as! Int64
        api.setFrameRateRange(minFrameRate: minFrameRateArg, maxFrameRate: maxFrameRateArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setFrameRateRangeChannel.setMessageHandler(nil)
    }
    /// Returns the supported frame rate ranges.
    let getSupportedFrameRateRangesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getSupportedFrameRateRanges\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSupportedFrameRateRangesChannel.setMessageHandler { _, reply in
        api.getSupportedFrameRateRanges { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    /// Sets video stabilization mode.
    let setVideoStabilizationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setVideoStabilization\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setVideoStabilizationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let enabledArg = args[0] as! Bool
        api.setVideoStabilization(enabled: enabledArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setVideoStabilizationChannel.setMessageHandler(nil)
    }
    /// Returns whether video stabilization is supported.
    let isVideoStabilizationSupportedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.isVideoStabilizationSupported\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      isVideoStabilizationSupportedChannel.setMessageHandler { _, reply in
        api.isVideoStabilizationSupported { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      isVideoStabilizationSupportedChannel.setMessageHandler(nil)
    }
    /// Returns the lens aperture value.
    let getLensApertureChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getLensAperture\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getLensApertureChannel.setMessageHandler { _, reply in
        api.getLensAperture { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getLensApertureChannel.setMessageHandler(nil)
    }
    /// Returns the focal length in millimeters.
    let getFocalLengthChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getFocalLength\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getFocalLengthChannel.setMessageHandler { _, reply in
        api.getFocalLength { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getFocalLengthChannel.setMessageHandler(nil)
    }
    /// Sets the torch level (0.0 to 1.0).
    let setTorchLevelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setTorchLevel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setTorchLevelChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let levelArg = args[0] as! Double
        api.setTorchLevel(level: levelArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setTorchLevelChannel.setMessageHandler(nil)
    }
    /// Gets the current torch level (0.0 to 1.0).
    let getTorchLevelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getTorchLevel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getTorchLevelChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getTorchLevel()
      ...
      getTorchLevelChannel.setMessageHandler(nil)
    }
    /// Returns whether torch level control is supported.
    let isTorchLevelSupportedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.isTorchLevelSupported\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      isTorchLevelSupportedChannel.setMessageHandler { _, reply in
        do {
          let result = try api.isTorchLevelSupported()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      isTorchLevelSupportedChannel.setMessageHandler(nil)
    }
    /// Returns the maximum supported torch level.
    let getMaxTorchLevelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxTorchLevel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getMaxTorchLevelChannel.setMessageHandler { _, reply in
        api.getMaxTorchLevel { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getMaxTorchLevelChannel.setMessageHandler(nil)
    }
    /// Sets a color effect filter.
    let setColorEffectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.setColorEffect\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setColorEffectChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let effectArg = args[0] as! PlatformColorEffect
        api.setColorEffect(effect: effectArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setColorEffectChannel.setMessageHandler(nil)
    }
    /// Returns the supported color effects.
    let getSupportedColorEffectsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getSupportedColorEffects\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getSupportedColorEffectsChannel.setMessageHandler { _, reply in
        api.getSupportedColorEffects { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getSupportedColorEffectsChannel.setMessageHandler(nil)
    }
  }
}
